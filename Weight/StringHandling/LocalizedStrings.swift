...
struct LocalizedStrings {
    static let weightLabel = NSLocalizedString("%.1f KG", comment: "Weight label display text");
    static let bmiLabel = NSLocalizedString("BMI: %.1f", comment: "BMI label display text")
    static let previousWeight = NSLocalizedString("Previous: %.1f KG", comment: "Previous weight label display text")
